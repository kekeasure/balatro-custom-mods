...
| [Balatro Score Preview / 分数预览](./BalatroScorePreview) | 1.1.0 | 在出牌前显示所选手牌的参考分数，并按游戏语言显示英文、简体中文或繁体中文 UI；常规 SMODS 概率判定在预览中按“不触发”处理，原版 Boss Blind 的随机弃牌/翻面等出牌前副作用不会真实作用到手牌。 |
