...
| 模组 | 版本 | 用途 |
| --- | --- | --- |
| [Balatro Step Back](./BalatroStepBack) | 0.2.0 | 在当前盲注内记录出牌/弃牌前的检查点，可回到最近一次或更早的操作前。 |
| [Balatro Score Preview](./BalatroScorePreview) | 0.3.0 | 在出牌前显示所选手牌的参考分数；常规 SMODS 概率判定在预览中按“不触发”处理。 |
