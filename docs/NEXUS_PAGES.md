...
Upload file: `BalatroModifierWarning-1.1.0.zip`

### Short Description

```text
Balatro Modifier Warning / 覆盖提醒 adds a clear replacement warning badge when a selected consumable would overwrite an existing playing-card enhancement or seal.
...
1. Install Lovely Injector.
2. Install Steamodded / SMODS.
3. Download BalatroModifierWarning-1.1.0.zip.
4. Extract the zip.
...
1. 安装 Lovely Injector。
2. 安装 Steamodded / SMODS。
3. 下载 BalatroModifierWarning-1.1.0.zip。
4. 解压压缩包。
